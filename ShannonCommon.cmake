...
macro(shannon_init_compiler_system)
	if(WIN32)
		...
		set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} /W3 /D UNICODE /wd4819")
...
macro(ImportMyBuildLib target_lib lib_path lib_name)
    add_library(${target_lib} STATIC IMPORTED)

    if(WIN32)
        set_target_properties(${target_lib} PROPERTIES IMPORTED_LOCATION_DEBUG ${lib_path}/${lib_name}d.lib )
        set_target_properties(${target_lib} PROPERTIES IMPORTED_LOCATION_RELEASE ${lib_path}/${lib_name}.lib )

    else(WIN32)
        set_target_properties(${target_lib} PROPERTIES IMPORTED_LOCATION_DEBUG ${lib_path}/lib${lib_name}d.a )
        set_target_properties(${target_lib} PROPERTIES IMPORTED_LOCATION_RELEASE ${lib_path}/lib${lib_name}.a )
    endif(WIN32)
endmacro(ImportMyBuildLib)
